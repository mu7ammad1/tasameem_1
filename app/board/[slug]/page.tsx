...
import SectionBady from "@/components/ui/SectionBady";
...
export default function Page({ params }: { params: { slug: string } }) {
  return (
    ...
    >
      <section className="flex justify-between items-center gap-3 w-full max-w-4xl sticky top-0 z-50 bg-background p-2">
        <div
          className={title({
